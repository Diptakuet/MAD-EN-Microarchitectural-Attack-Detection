...
do
  ...
  echo $(($pow1-$pow)) >> /home/Debopriya/medusa/Topic_3_Data_collection/All_Data/Useful_Resource/Benign_Application/RealWorld/pycharm/Data/pycharm_run_code_dram_1_50.csv
  sleep 0.0005
done
