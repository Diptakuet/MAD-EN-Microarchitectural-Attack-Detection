...
char publicKey[]="-----BEGIN PUBLIC KEY-----\n"\
    "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDmTvQjjtGtnIqMwmmaLW+YjbYT\n"\
    "sNR8PGKXr78iYwrMV5Ye4VGyBwS6qLD4s/EzCzGIDwkWCVx+gVHvh2wGW15Ddof0\n"\
    "gVAtAMkR6gRABy4TkK+6YFSKAyjmHvKCfFHvc9loeFGDyjmwFFkfdwzppXnH1Wwt\n"\
    "0OlnyCU1GbQ1w7AHuwIDAQAB\n"\
    "-----END PUBLIC KEY-----";
...
int main(){
    ...
    char plainText[2048/8] = "Testing Medusa Attack During Encryption and Decryption by Debopriya Roy Dipta and Berk Gulmezoglu Testing Medusa"  ; //key length : 2048
