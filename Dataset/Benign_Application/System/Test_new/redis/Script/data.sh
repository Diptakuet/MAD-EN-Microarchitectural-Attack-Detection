...
do
  ...
  echo $(($pow1-$pow)) >> /home/Debopriya/medusa/Topic_3_Data_collection/All_Data/Useful_Resource/Benign_Application/System/Test_new/redis/Data/test_redis_core_1_10.csv
  sleep 0.0005
done
