...
do
  ...
  echo $(($pow1-$pow)) >> ~/Dataset/Benign_Application/Processor/botan/Data/test_botan_CAST-256_dram_1_50.csv
  sleep 0.0005
done
...
do
  ...
  echo $(($pow1-$pow)) >> ~/Dataset/Benign_Application/botan/Data/botan_CAST-256_core_1_50.csv
  sleep 0.0005
done
#end_time=$(date +%s)
#elapsed=$(( end_time - start_time ))
