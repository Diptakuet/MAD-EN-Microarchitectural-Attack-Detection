...
do
  ...
  echo $(($pow1-$pow)) >> /home/Debopriya/medusa/Topic_3_Data_collection/All_Data/Useful_Resource/Benign_Application/Processor/Test_new/amg/Data/test_amg_core_1_10.csv
  sleep 0.0005
done
#end_time=$(date +%s)
