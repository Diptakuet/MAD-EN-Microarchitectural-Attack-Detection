...
do
  ...
  echo $(($pow1-$pow)) >> ~/Dataset/Benign_Application/Processor/arrayfire/Data/arrayfire_cg_cpu_core_1_50.csv
  sleep 0.0005
done
...
do
  ...
  echo $(($pow1-$pow)) >> ~/Dataset/Benign_Application/Processor/arrayfire/Data/arrayfire_blas_cpu_dram_1_50.csv
  sleep 0.0005
done
#end_time=$(date +%s)
#elapsed=$(( end_time - start_time ))
