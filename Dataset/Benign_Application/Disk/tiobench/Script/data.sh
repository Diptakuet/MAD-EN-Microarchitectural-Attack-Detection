...
do
  ...
  echo $(($pow1-$pow)) >> /home/Debopriya/medusa/Topic_3_Data_collection/All_Data/Useful_Resource/Benign_Application/Disk/tiobench/Data/tiobench_read_core_1_50.csv
  sleep 0.0005
done
...
do
  ...
  echo $(($pow1-$pow)) #>> /home/Debopriya/medusa/Topic_3_Data_collection/All_Data/Useful_Resource/Benign_Application/Disk/tiobench/Data/tiobench_read_dram_1_50.csv
  sleep 0.0005
done
#end_time=$(date +%s)
#elapsed=$(( end_time - start_time ))
